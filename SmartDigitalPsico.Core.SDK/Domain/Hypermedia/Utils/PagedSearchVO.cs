...
namespace SmartDigitalPsico.Core.SDK.Domain.Hypermedia.Utils;

/// <summary>
/// PagedSearchVO — espelho SCH (constraint ISupportsHyperMedia SDP; ≠ PagedResult).
/// </summary>
[SdkWrappedSource(
    targetType: "SmartCoreHub.Core.SDK.Domain.Hypermedia.Utils.PagedSearchVO`1",
    targetPackage: "SmartCoreHub.Core.SDK",
    description: "Espelho PagedSearchVO; constraint ISupportsHyperMedia SDP.")]
