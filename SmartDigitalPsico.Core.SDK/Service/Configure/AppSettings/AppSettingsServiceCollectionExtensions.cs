...
/// <summary>
/// DI AppSettings SDP — bind SMTP/resilience/cache/auth/location (ausente como AddCore* único no SCH).
/// </summary>
[SdkWrappedSource(
    targetType: "SmartCoreHub.Core.SDK.Service.DependenciesCollection.Extensions.CoreServiceCollectionExtensions",
    targetPackage: "SmartCoreHub.Core.SDK",
    description: "AddCoreAppSettings SDP-only; bind IConfiguration → DTOs/ifaces casca.")]
