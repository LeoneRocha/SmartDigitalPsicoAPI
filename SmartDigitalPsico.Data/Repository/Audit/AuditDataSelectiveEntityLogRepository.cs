...
namespace SmartDigitalPsico.Data.Repository
{
    ...
    /// </summary>
    public class AuditDataSelectiveEntityLogRepository : Core.SDK.Data.Repository.Generic.GenericRepositoryEntityBase<AuditDataSelectiveEntityLog>, IAuditDataSelectiveEntityLogRepository
    {
        /// <summary>
