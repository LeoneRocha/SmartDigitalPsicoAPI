...
namespace SmartDigitalPsico.Data.Repository.Principals
{
    ...
    /// </summary>
    public class PatientAdditionalInformationRepository : SmartDigitalPsicoAPI.Core.SDK.Data.Repository.Generic.GenericRepositoryEntityBase<PatientAdditionalInformation>, IPatientAdditionalInformationRepository
    {
        /// <summary>
        /// Método PatientAdditionalInformationRepository: executa a operação PatientAdditionalInformationRepository.
        /// </summary>
        public PatientAdditionalInformationRepository(IEntityDataContext context) : base((Microsoft.EntityFrameworkCore.DbContext)context) { }
