...
namespace SmartDigitalPsico.Data.Migrations.MySql
{
    ...
    [Migration("20260802143910_AddScheduleGenericModule")]
    partial class AddScheduleGenericModule
    {
        /// <inheritdoc />
        /// <summary>
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartDigitalPsico.Domain.EntityModels.Schedule.ScheduleCalendar", b =>
                {
                    ...
                    b.Property<string>("TimeZoneDefault")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("varchar(150)");
                    ...
                    b.HasIndex("TenantKey", "OwnerKey")
                        .HasDatabaseName("IX_ScheduleCalendar_Tenant_Owner");
            ...
            modelBuilder.Entity("SmartDigitalPsico.Domain.EntityModels.Schedule.ScheduleOccurrence", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("SeriesToken")
                        .HasDatabaseName("IX_ScheduleOccurrence_SeriesToken");

                    b.HasIndex("ExternalSource", "ExternalId")
                        .HasDatabaseName("IX_ScheduleOccurrence_External");

                    b.HasIndex("OwnerKey", "StartDateTime")
                        .HasDatabaseName("IX_ScheduleOccurrence_Owner_Start");

                    b.HasIndex("CalendarId", "StartDateTime", "EndDateTime")
                        .HasDatabaseName("IX_ScheduleOccurrence_Calendar_Start_End");

                    b.ToTable("ScheduleOccurrence", "dbo");

                    MySqlEntityTypeBuilderExtensions.HasCharSet(b, "latin1");
                });

            modelBuilder.Entity("SmartDigitalPsico.Domain.EntityModels.Schedule.ScheduleSeries", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("SeriesToken")
                        .IsUnique()
                        .HasDatabaseName("UX_ScheduleSeries_SeriesToken");

                    b.ToTable("ScheduleSeries", "dbo");
            ...
            modelBuilder.Entity("SmartDigitalPsico.Domain.EntityModels.Schedule.ScheduleOccurrence", b =>
                {
                    b.HasOne("SmartDigitalPsico.Domain.EntityModels.Schedule.ScheduleCalendar", "Calendar")
                        .WithMany("Occurrences")
                        .HasForeignKey("CalendarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SmartDigitalPsico.Domain.EntityModels.Schedule.ScheduleSeries", "Series")
                        .WithMany("Occurrences")
