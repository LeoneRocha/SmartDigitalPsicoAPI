    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2024, 3, 24, 18, 47, 2, 164, DateTimeKind.Local).AddTicks(2222), "Default", true, "", "", "pt-BR", new DateTime(2024, 3, 24, 18, 47, 2, 164, DateTimeKind.Local).AddTicks(2239), new DateTime(2024, 3, 24, 18, 47, 2, 164, DateTimeKind.Local).AddTicks(2239), 1, 0, 0 });

            migrationBuilder.InsertData(
                schema: "dbo",
                table: "ApplicationLanguage",
                columns: new[] { "Id", "CreatedDate", "Description", "Enable", "Language", "LanguageKey", "LanguageValue", "LastAccessDate", "ModifyDate" },
                values: new object[] { 1L, new DateTime(2024, 3, 24, 18, 47, 2, 164, DateTimeKind.Local).AddTicks(2290), "Default", true, "pt-BR", "Default_ptbr", "Padrão", new DateTime(2024, 3, 24, 18, 47, 2, 164, DateTimeKind.Local).AddTicks(2291), new DateTime(2024, 3, 24, 18, 47, 2, 164, DateTimeKind.Local).AddTicks(2291) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, true, new DateTime(2024, 3, 24, 18, 47, 2, 164, DateTimeKind.Local).AddTicks(2564), "admin@sistemas.com", true, "pt-BR", new DateTime(2024, 3, 24, 18, 47, 2, 164, DateTimeKind.Local).AddTicks(2565), "admin", null, new DateTime(2024, 3, 24, 18, 47, 2, 164, DateTimeKind.Local).AddTicks(2566), "User MOCK ", new byte[] { 216, 199, 9, 42, 0, 116, 156, 174, 126, 180, 76, 132, 210, 249, 36, 139, 122, 12, 130, 244, 117, 17, 223, 204, 88, 222, 41, 93, 65, 5, 151, 16, 53, 29, 234, 154, 243, 209, 78, 17, 79, 234, 84, 77, 128, 233, 104, 66, 128, 151, 85, 150, 9, 37, 189, 106, 141, 87, 207, 183, 0, 250, 237, 158 }, new byte[] { 196, 230, 212, 63, 152, 115, 18, 195, 24, 30, 252, 124, 182, 193, 32, 161, 223, 157, 103, 219, 212, 43, 199, 161, 35, 19, 218, 28, 151, 191, 157, 52, 11, 240, 240, 114, 160, 33, 111, 114, 50, 88, 43, 143, 5, 12, 158, 228, 227, 56, 1, 101, 150, 245, 64, 118, 20, 102, 254, 181, 84, 188, 87, 112, 17, 34, 7, 106, 123, 211, 72, 153, 32, 88, 14, 15, 20, 191, 254, 147, 93, 27, 73, 126, 203, 73, 57, 187, 38, 207, 45, 145, 238, 235, 124, 121, 62, 8, 70, 28, 95, 82, 86, 216, 35, 193, 221, 207, 19, 241, 175, 252, 124, 203, 145, 109, 128, 212, 243, 214, 118, 5, 179, 80, 150, 11, 74, 61 }, null, null, "Admin", "E. South America Standard Time" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "123456", new DateTime(2024, 3, 24, 18, 47, 2, 166, DateTimeKind.Local).AddTicks(3913), 1L, "medical@sistemas.com", true, new DateTime(2024, 3, 24, 18, 47, 2, 166, DateTimeKind.Local).AddTicks(3917), new DateTime(2024, 3, 24, 18, 47, 2, 166, DateTimeKind.Local).AddTicks(3918), null, "Medical MOCK ", 3L, null, 0, null });
            ...
            migrationBuilder.InsertData(
                ...
                table: "Users",
                columns: new[] { "Id", "Admin", "CreatedDate", "Email", "Enable", "Language", "LastAccessDate", "Login", "MedicalId", "ModifyDate", "Name", "PasswordHash", "PasswordSalt", "Refresh_token", "Refresh_token_expiry_time", "Role", "TimeZone" },
                values: new object[] { 2L, false, new DateTime(2024, 3, 24, 18, 47, 2, 166, DateTimeKind.Local).AddTicks(4252), "doctor@sistemas.com", true, "pt-BR", new DateTime(2024, 3, 24, 18, 47, 2, 166, DateTimeKind.Local).AddTicks(4253), "doctor", 1L, new DateTime(2024, 3, 24, 18, 47, 2, 166, DateTimeKind.Local).AddTicks(4254), "User Medical", new byte[] { 202, 69, 61, 53, 250, 34, 13, 150, 237, 75, 251, 14, 66, 12, 166, 247, 0, 240, 176, 162, 209, 209, 83, 236, 194, 219, 185, 152, 182, 1, 74, 19, 30, 212, 189, 159, 193, 191, 188, 249, 139, 181, 67, 39, 74, 139, 153, 180, 88, 146, 184, 142, 201, 158, 129, 192, 145, 145, 127, 110, 158, 184, 135, 142 }, new byte[] { 88, 220, 253, 123, 255, 198, 166, 33, 51, 36, 193, 85, 145, 16, 196, 7, 169, 59, 9, 68, 206, 86, 55, 130, 33, 253, 2, 205, 10, 185, 122, 93, 78, 88, 96, 205, 153, 96, 207, 250, 175, 79, 194, 143, 205, 209, 135, 39, 194, 116, 140, 168, 197, 61, 54, 200, 177, 21, 208, 180, 223, 171, 80, 253, 137, 157, 249, 17, 235, 198, 28, 174, 37, 239, 137, 82, 59, 251, 241, 18, 175, 42, 232, 138, 42, 46, 194, 238, 119, 67, 186, 134, 15, 229, 199, 221, 130, 230, 253, 186, 202, 4, 192, 244, 159, 43, 143, 220, 75, 45, 236, 9, 82, 193, 206, 237, 75, 212, 33, 246, 255, 134, 53, 42, 83, 175, 234, 228 }, null, null, "Medical", "E. South America Standard Time" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "45675-970", "Aurelino Leal", "Centro", "Bahia", "Avenida Presidente Médici 264", "947.846.605-42", new DateTime(2024, 3, 24, 18, 47, 2, 168, DateTimeKind.Local).AddTicks(3844), 2L, new DateTime(1960, 3, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "Superior", "tiago.thales.mendes@andrade.com", "Milena Isabelly Vanessa", "(73) 98540-4268", true, 1L, new DateTime(2024, 3, 24, 18, 47, 2, 168, DateTimeKind.Local).AddTicks(3847), 0, 1L, new DateTime(2024, 3, 24, 18, 47, 2, 168, DateTimeKind.Local).AddTicks(3847), null, "Tiago Thales Mendes", "(73) 2877-3408", "Professor", "13.809.283-7" });
