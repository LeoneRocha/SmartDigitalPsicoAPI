...
{
    /// <summary>
    /// Classe responsável por PatientMockData.
    ...
    public static class PatientMockData
    {
        ...
        // Paciente 8 — seed para validar migration incremental (InsertData)
        new Patient
        {
            Id = 8,
            Name = "Helena Beatriz Nogueira",
            Email = "helena.nogueira@example.com",
            CreatedDate = new DateTime(2026, 8, 1, 12, 0, 0, DateTimeKind.Utc),
            Enable = true,
            LastAccessDate = new DateTime(2026, 8, 1, 12, 0, 0, DateTimeKind.Utc),
            ModifyDate = new DateTime(2026, 8, 1, 12, 0, 0, DateTimeKind.Utc),
            CreatedUserId = 2,
            ...
            Cpf = "321.654.987-00",
            DateOfBirth = new DateTime(1995, 4, 8, 0, 0, 0, DateTimeKind.Utc),
            Education = "Superior Completo",
