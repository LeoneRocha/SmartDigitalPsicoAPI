...
{
    /// <summary>
    /// Classe responsável por AuditDataSelectiveEntityLogConfiguration.
    /// Responsabilidade: configuração de startup/DI da aplicação.
    /// Relação: integra as camadas Domain/Data/Service/WebAPI do SmartDigitalPsico.
    /// </summary>
    public class AuditDataSelectiveEntityLogConfiguration : SmartDigitalPsico.Core.SDK.Data.Context.Configure.EntityBaseConfiguration<AuditDataSelectiveEntityLog>
    {
        /// <summary>
        /// Método AuditDataSelectiveEntityLogConfiguration: executa a operação AuditDataSelectiveEntityLogConfiguration.
        /// </summary>
