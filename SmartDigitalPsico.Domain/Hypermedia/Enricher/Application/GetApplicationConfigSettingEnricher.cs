...
namespace SmartDigitalPsico.Domain.Hypermedia.Enricher.Application
{
    /// <summary>
    ...
    /// </summary>
    public class GetApplicationConfigSettingEnricher : SmartDigitalPsico.Core.SDK.Domain.Hypermedia.ContentResponseEnricher<GetApplicationConfigSettingDto>
