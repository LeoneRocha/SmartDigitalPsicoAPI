...
namespace SmartDigitalPsico.Domain.Hypermedia.Enricher.User
{
    /// <summary>
    ...
    /// </summary>
    public class GetUserEnricher : SmartDigitalPsico.Core.SDK.Domain.Hypermedia.ContentResponseEnricher<GetUserDto>
