...
{
    /// <summary>
    /// Classe responsável por SmartDigitalPsicoAPI.Core.SDK.Domain.VO.TokenVO.
    ...
    {
        /// <summary>
        /// Método SmartDigitalPsicoAPI.Core.SDK.Domain.VO.TokenVO: mapeia ou transforma dados entre modelos.
        /// </summary>
        public TokenVO()
        {
        } 
