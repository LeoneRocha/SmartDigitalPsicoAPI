...
namespace SmartDigitalPsico.Domain.Validation
{
    ...
    /// </summary>
    public class PatientAppointmentCriteriaDtoValidator : AbstractValidator<AppointmentCriteriaDto>
    {
        private readonly IPatientRepository _patientRepository;
        /// <summary>
        /// Método AppointmentCriteriaDtoValidator: executa a operação AppointmentCriteriaDtoValidator.
        /// </summary>
        public PatientAppointmentCriteriaDtoValidator(IPatientRepository patientRepository)
        {
