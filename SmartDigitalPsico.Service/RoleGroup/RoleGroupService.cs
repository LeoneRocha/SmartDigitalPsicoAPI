...
namespace SmartDigitalPsico.Service.RoleGroup
{
    ...
    /// </summary>
    public class RoleGroupService : SmartDigitalPsico.Service.Common.EntityBaseService<RoleGroup, GetRoleGroupDto>, IRoleGroupService
