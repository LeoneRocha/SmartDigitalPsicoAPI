...
{
    public class EntityBaseSimpleService<TEntity, TEntityAdd, TEntityUpdate, TEntityResult, Repo>
        : IEntityBaseSimpleService<TEntity, TEntityAdd, TEntityUpdate, TEntityResult>
        where TEntity : EntityBaseSimple
        where TEntityAdd : IEntityVOAdd
        where TEntityUpdate : IEntityVO
        where TEntityResult : class
        where Repo : IEntityBaseSimpleRepository<TEntity>

    {
        ...
        public EntityBaseSimpleService(IMapper mapper, Repo UserRepository,
        ...
        private async Task<string> getMessageFromLocalization(string key)
        {
            try
            {
                return await ApplicationLanguageService.GetLocalization<SharedResource>
                                   (key, this._applicationLanguageRepository, _cacheService);
            }
            catch (Exception)
            {
