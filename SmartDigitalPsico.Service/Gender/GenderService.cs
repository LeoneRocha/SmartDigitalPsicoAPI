...
namespace SmartDigitalPsico.Service.Gender
{
    ...
    /// </summary>
    public class GenderService : SmartDigitalPsico.Service.Common.EntityBaseService<Gender, GetGenderDto>, IGenderService
    {
        /// <summary>
