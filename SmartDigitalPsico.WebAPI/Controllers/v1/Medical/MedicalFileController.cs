...
namespace SmartDigitalPsico.WebAPI.Controllers.v1
{
    ...
    public class MedicalFileController : Domain.API.ApiBaseController
    {
        ...
        public async Task<ActionResult> DownloadFileById(long id)
        {
            ...
            var response = SmartDigitalPsico.Core.SDK.Domain.Helpers.FileHelper.ProccessDownloadToBrowser(DirectoryHelper.GetDiretoryTemp(_configuration), result.FileName);
            return response;
        }
